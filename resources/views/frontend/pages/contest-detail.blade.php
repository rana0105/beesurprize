					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							<div class="contest-detail-right">
								...
								<small>This competition has a maximum of 29994 entries.</small>
								<p class="contest-no">Contest No: <span>bt2</span></p>
								<span>Tickets Sold</span> <br>
								<div class="starting-qty">0</div>
								<div class="total-qty">25680</div>
								<div class="progress">
								  	<div class="progress-bar" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
								<small class="remaining-ticket"> Only 1203 remaining!</small>
